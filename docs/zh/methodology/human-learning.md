...
CFLT 通过将语言视为“语义乐高”来解决这个问题 —— **协议层**序列（核心 → 理由 → 空间 → 时间）无论目标语言为何都保持相同，而核心的**内部组装**（格标记、助词、介词、核内语序）则交由每种语言的原生句法处理。分层划分参见 [`../foundations/core-concept.md`](../foundations/core-concept.md) §2.3。
