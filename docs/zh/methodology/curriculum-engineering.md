...
>
> **理论锚点：** 本文件操作化了 [`foundations/pedagogy.md`](../foundations/pedagogy.md) §6 (任务型语言教学) 和 §8 (双语词汇提取)，并依赖于 [`foundations/linguistics.md`](../foundations/linguistics.md) §8 (构式语法槽位填充) 和 §9 (作为槽位填充词汇的自然语义金属语言 NSM)。“令牌包 (Token-pack)”设计是这些理论承诺在工程层面的具体体现。
