...
1.  **教学的"人造性" / 僵化风险。** 严格的四插槽句子对高级学习者来说可能感觉很不自然。这就是 Skehan (1998) 的权衡假设所警告的风险 —— 公式化模板可能使学习者在*流利度*上达到平台，而以*复杂度*和*准确性*为代价。系统必须管理**向显性偏离的过渡**（宣言 §3.1），以避免流利度天花板。§11 的支架消退课程是 CFLT 针对该风险的具体应对。
