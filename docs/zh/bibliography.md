...
- [逻辑与语言哲学](#逻辑与语言哲学)
- [数学与信息论](#数学与信息论)
- [大语言模型与自然语言处理](#大语言模型与自然语言处理)
- [教育学与第二语言习得](#教育学与第二语言习得)
- [神经科学](#神经科学)
- [相关领域 (在 `manifesto.md` §4 中用于区分引用)](#相关领域-在-manifestomd-4-中用于区分引用)
...
- **Yoon, J. H.-S.** (2009). "The Distribution of Subject Properties in Multiple Subject Constructions." In *Japanese/Korean Linguistics 16*, Iwasaki et al. (eds). Stanford: CSLI Publications.
...
- **Lai, V. D., Ngo, N. T., Ben Veyseh, A. P., Man, H., Dernoncourt, F., Bui, T. & Nguyen, T. H.** (2023). "ChatGPT Beyond English: Towards a Comprehensive Evaluation of Large Language Models in Multilingual Learning." *Findings of EMNLP*. [链接](https://aclanthology.org/2023.findings-emnlp.878/)
...
- **LMSYS Org.** (2024). "SGLang: Efficient Execution of Structured Language Model Programs." *LMSYS Blog*. [链接](https://lmsys.org/blog/2024-01-17-sglang/)
- **Zhang, R., Yang, T. et al.** (2023). "Don't Trust ChatGPT when Your Question Is Not in English: A Study of Multilingual Abilities and Types of LLMs." *EMNLP*. [链接](https://aclanthology.org/2023.emnlp-main.491/)
...
- **Vaswani, A. et al.** (2017). "Attention Is All You Need." *NeurIPS*. [官方链接](https://papers.nips.cc/paper_files/paper/2017/hash/3f5ee243547dee91fbd053c1c4a845aa-Abstract.html)
...
- **Brown, P. & Levinson, S. C.** (1987). *Politeness: Some Universals in Language Usage.* Cambridge: Cambridge University Press. *(也列于社会语言学下；此处引用是为了支持与请求核心相关的“礼貌作为补救”框架。)*
...
- **Frazier, L.** (1987). "Sentence Processing: A Tutorial Review." In *Attention and Performance XII: The Psychology of Reading*, Coltheart (ed). Hillsdale, NJ: Erlbaum, 559–586.
...
- **Schmidt, R. W.** (1983). "Interaction, Acculturation, and the Acquisition of Communicative Competence: A Case Study of an Adult." In *Sociolinguistics and Language Acquisition*, Wolfson & Judd (eds), 137–174. Rowley, MA: Newbury House.
