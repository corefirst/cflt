...
1. **[Condition/Reason]** — Why or under what condition? (*because it rained*)
2. **[Space/Context]** — Where? (*at home*)
...
Neuroimaging and reaction-time studies (e.g., **Yokoyama et al. 2006** [[10.1016/j.neuroimage.2005.09.064](https://doi.org/10.1016/j.neuroimage.2005.09.064)]) confirm that word-order typologies (SVO vs. SOV) dictate different neural processing costs.
