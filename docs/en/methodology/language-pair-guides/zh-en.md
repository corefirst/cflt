...
This converts a **selection problem** (Chinese L1 has no tense to copy from) into a **bookkeeping rule** (check the Time slot, retro-validate the verb).

> **Honest scope (Lardiere caveat).** Lardiere (1998, 2003) "Patty" case study showed that even an advanced Chinese L1 learner produced English past-tense morphology at only ~6% — the bottleneck is *production*, not *selection*. The cited causes are (a) Mandarin phonotactic constraints (no syllable-final consonant clusters) suppressing *-ed* surface forms; (b) the "Missing Surface Inflection" challenge documented by Hawkins & Liszka (2003 *Prosodic Transfer Hypothesis*) and Goad & White (2006). The Backward Temporal Constraint solves the *which-tense* problem; it does **not** solve the *how-to-produce-the-inflection* problem. Effective Chinese→English tense pedagogy must combine CFLT's temporal scaffolding with explicit phonological and morphological training.
