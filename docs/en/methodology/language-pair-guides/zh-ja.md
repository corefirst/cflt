...
The politeness markers (能…吗 in Chinese, -てくれませんか in Japanese) attach inside Core (Request type). They are not a separate slot.
...
**CFLT decomposition**:
- Core (Identity): 那个女孩是我妹妹 / あの女の子は私の妹だ
...
**CFLT decomposition**:
- Core (Action, fully assembled): 他用筷子慢慢地为妈妈做了一道菜 / 彼は箸でゆっくり母のために料理を作った
