...
See [`bibliography.md`](../bibliography.md). Key methodological anchors used to define the metrics in this document: Hawkins (1994, 2004) for EIC; Levelt (1989) and Kormos (2006) for production-latency baselines; Liu et al. (2023) for the Needle-in-a-Haystack methodology; Xiao et al. (2024) for the attention-sink mechanism underlying IPS; Sclar et al. (2024) and Lu et al. (2022) for prompt-order sensitivity baselines.
